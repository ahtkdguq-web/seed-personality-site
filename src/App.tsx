...
import cultureGatheringHero from './hero-culture-gathering.png'
...
const testimonials = [
  ['“나를 억지로 바꾸려 하기보다, 내 모습 그대로의 강점을 찾게 됐어요.”', '최○린', '26세 · 성격 유형 검사'],
  ['“막막했던 미래를 나다운 속도로 그려볼 수 있게 되었어요.”', '유○진', '24세 · 인생 그래프'],
  ['“이제는 다른 사람과 비교하지 않고 마음이 한결 편안해졌어요.”', '박○희', '28세 · 핵심 감정 검사'],
  ['“처음 만난 사람들과도 부담 없이 이야기할 수 있는 모임이라 좋았어요.”', '김○현', '27세 · SEED 밋업'],
  ['“주말이 기다려지는 건 오랜만이에요. 새로운 취향도 많이 발견했어요.”', '이○서', '25세 · 문화 행사'],
...
function App() {
  ...
  return <div className="site">
    ...
    <main id="top">
      <section className="hero hero-culture hero-campaign"><img className="campaign-photo" src={cultureGatheringHero} alt="한국 청년들이 함께하는 SEED 문화 모임" /><div className="hero-content"><p className="culture-chip"><span>✦</span> FOR YOUNG CULTURE</p><h1>좋은 사람들과,<br /><em>더 행복한 오늘을.</em></h1><p>SEED는 청년들의 삶에 건강한 연결을 심는 문화 콘텐츠 스타트업입니다.<br />편안한 모임과 다채로운 행사에서, 나답게 웃고 성장할 순간을 만듭니다.</p><div className="hero-actions"><button className="cta" onClick={() => scrollTo('programs')}>SEED 프로그램 보기 <span>→</span></button><button className="ghost" onClick={startEmotion}>나를 알아가는 시간</button></div></div><div className="campaign-glow" aria-hidden="true" /></section>
      ...
      <section id="pricing" className="pricing membership"><div className="membership-intro"><p className="eyebrow">SEED MEMBERSHIP</p><h2>당신에게 맞는 플랜을<br />선택하세요</h2><p>나를 알아가는 시간도, 좋은 사람들과 연결되는 경험도. SEED는 당신의 속도에 맞춰 함께합니다.</p><div className="membership-points"><span>✦ 내 속도로 시작</span><span>✦ 함께하는 성장</span><span>✦ 매달 돌아보는 나</span></div></div><div className="membership-layout"><aside className="membership-guide"><p>MEMBERSHIP GUIDE</p><h3>혼자보다,<br /><em>함께 더 멀리.</em></h3><span>SEED 멤버십은 나를 이해하고 일상 속 작은 변화를 이어 갈 수 있도록 돕는 가장 가까운 성장 파트너입니다.</span><ul><li><b>01</b> 나를 발견하는 콘텐츠</li><li><b>02</b> 안전한 커뮤니티 연결</li><li><b>03</b> 한 달의 성장 기록</li></ul></aside><div className="price-grid"><article className="plan-card"><div className="plan-head"><div><p>MONTHLY</p><h3>월간 구독</h3></div><span>가볍게 시작</span></div><p className="plan-for">SEED가 처음이거나, 부담 없이 나에게 맞는 리듬을 찾고 싶다면</p><strong>79,000<small>원 / 월</small></strong><span className="plan-billing">매월 자유롭게 이어 가는 플랜</span><ul><li>전체 콘텐츠 무제한 이용</li><li>커뮤니티 참여 가능</li><li>월간 성장 리포트</li></ul><button onClick={startQuiz}>월간 플랜으로 시작 <span>→</span></button></article><article className="plan-card featured"><em>가장 인기 있는 선택</em><div className="plan-head"><div><p>YEARLY</p><h3>연간 구독</h3></div><span>꾸준한 성장</span></div><p className="plan-for">SEED와 더 오래, 가장 합리적인 방식으로 함께하고 싶다면</p><strong>59,000<small>원 / 월</small></strong><span className="plan-billing">연 708,000원 · 25% 이상 할인</span><ul><li>전체 콘텐츠 무제한 이용</li><li>커뮤니티 참여 가능</li><li>월간 성장 리포트</li><li>전문가 1:1 코칭 세션</li></ul><button onClick={startQuiz}>할인받고 시작하기 <span>→</span></button></article></div></div><p className="membership-foot"><b>어떤 플랜부터 시작할지 고민된다면?</b> 처음이라면 월간으로, SEED와 꾸준한 변화를 만들고 싶다면 연간으로 시작해 보세요.</p></section>
